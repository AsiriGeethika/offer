      ...
      <View style={styles.container}>
        <View style={styles.container1}>     
            ...
            <Text style={styles.add}>SALE</Text>
              <CustomImage imageSource={require('../img/offer.png')}/>
            ...
            <View style={styles.col1}>
                ...
                <CustomImage imageSource={require('../img/frock.jpg')}/>
            ...
            <View style={styles.col1}>
                ...
                <CustomImage imageSource={require('../img/shirt.jpg')}/>
        ...
        <View style={styles.container2}>
            ...
            <Text style={styles.add}>25% OFF</Text>
                <CustomImage imageSource={require('../img/sportshoes.jpeg')}/>
                <Text style={styles.item}>Nike Sports Shoes</Text>
            ...
            <View style={styles.col2}>
                ...
                <CustomImage imageSource={require('../img/Shoe.jpg')}/>
            ...
            <View style={styles.col2}>
                ...
                <CustomImage imageSource={require('../img/xlarge.jpg')}/>
